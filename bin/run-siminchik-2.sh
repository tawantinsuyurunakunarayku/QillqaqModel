...
python -u DeepSpeech.py \
  --train_files "/home/ubuntu/corpus_rodolfo/quz-train.csv" \
  --dev_files "/home/ubuntu/corpus_rodolfo/quz-dev.csv" \
  --test_files "/home/ubuntu/corpus_rodolfo/quz-test.csv" \
  ...
  --summary_secs 30 \
  --log_level 0 \
  --checkpoint_dir "/home/ubuntu/corpus_rodolfo/model_final_3" \
  --export_dir "/home/ubuntu/corpus_rodolfo/models_3"
  "$@"
~  
